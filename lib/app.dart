...
class App extends StatelessWidget {
  ...
  Map<String, WidgetBuilder> _buildRoutes() {
    return {
      ...
      '/create-post': (context) => CreatePostBottomSheet(),
      '/matches': (context) => const MatchesScreen(),
      '/notifications': (context) => const RequestAlertScreen(),
...
class _MainScreenState extends State<MainScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: _buildBottomNavigationBarWithDynamicBadges(),
    );
  }

  Widget _buildBottomNavigationBarWithDynamicBadges() {
    return Container(
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Consumer2<MessagingProvider, NotificationProvider>(
            builder: (context, messagingProvider, notificationProvider, _) {
              return Row(
                ...
                children: [
                  ...
                  _buildNavItem(
                    ...
                    label: 'Messages',
                    index: 2,
                    badge: messagingProvider.totalUnreadCount, // ✅ Dynamic from provider
                  ),
                  _buildNavItem(
                    ...
                    label: 'Alerts',
                    index: 3,
                    badge: notificationProvider.unreadCount, // ✅ Dynamic from provider
                  ),
                  _buildNavItem(
